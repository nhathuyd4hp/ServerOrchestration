...
Revision ID: 53cf62e59e46
Revises:
Create Date: 2025-12-15 08:15:31.439935
...
revision: str = "53cf62e59e46"  # pragma: allowlist secret
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("CANCEL", "PENDING", "FAILURE", "SUCCESS", name="status"), nullable=False),
